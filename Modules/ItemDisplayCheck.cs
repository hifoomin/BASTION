...
namespace Bastion.Modules
{
    internal static class ItemDisplayCheck
    {
        ...
        public static void PrintUnused(IEnumerable<ItemDisplayRuleSet.KeyAssetRuleGroup> ruleSet = null, string bodyName = "")
        {
            ...
            {
                string thing = $"";
                if (ItemDisplayBase.KeyAssetDisplayPrefabs.ContainsKey(keyAsset))
                {
                    ...
                    thing += SpitOutNewRule(keyAsset, firstCompatibleChild, ItemDisplayBase.KeyAssetDisplayPrefabs[keyAsset]);
                }
                else
                {
        ...
        {
            allDisplayedItems = new List<Object>(ItemDisplayBase.KeyAssetDisplayPrefabs.Keys);
