...
namespace Bastion.Modules.Characters
{
    public abstract class CharacterBase<T> where T : CharacterBase<T>, new()
    {
        ...
        {
            instance = this as T;
            assetBundle = AssetBase.LoadAssetBundle(assetBundleName);
        ...
        {
            characterModelObject = PrefabBase.LoadCharacterModel(assetBundle, modelPrefabName);

            bodyPrefab = PrefabBase.CreateBodyPrefab(characterModelObject, bodyInfo);
            prefabCharacterBody = bodyPrefab.GetComponent<CharacterBody>();

            prefabCharacterModel = PrefabBase.SetupCharacterModel(bodyPrefab, customRendererInfos);
        }
        ...
        public virtual void InitializeItemDisplays()
        {
            ...
            {
                Modules.ItemDisplayBase.queuedDisplays++;
